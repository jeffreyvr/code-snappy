<template>
  <div>
    <div :class="(resizeable ? 'min-w-xs max-w-full ' : 'max-w-2xl') + ' mx-auto container'">
      <div class="flex justify-center">
        ...
        >
          ...
          <vue-prism-editor v-model="code" :language="language" ref="editor"></vue-prism-editor>
        </div>
      </div>
    </div>
        ...
        <div>
          ...
          <div class="block mt-2">
            <label class="md:w-2/3 block text-gray-500 font-bold">
              <input type="checkbox" v-model="resizeable" class="mr-2 leading-tight" />
              <span class="text-sm">Resizeable</span>
            </label>
          </div>
        </div>
        <div>
